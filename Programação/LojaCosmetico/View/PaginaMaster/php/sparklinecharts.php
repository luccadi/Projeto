<?php
$page = 'sparklinecharts';
$title = 'Sparkline Charts';
$css = <<<EOT
<!--page level css -->
<link href="../css/pages/sparklinecharts.css" rel="stylesheet" type="text/css" />
    ...
    <section class="content paddingleft_right15">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title"> <i class="livicon" data-name="spinner-five" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                    Sparkline Charts
                </h3>
            </div>
...
<script src="../js/pages/sparkline.js" type="text/javascript"></script>
