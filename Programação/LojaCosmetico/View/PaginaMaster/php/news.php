                ...
                <div class="row">
                    <div class="col-md-5">
                        <div id="myCarousel" class="carousel image-carousel slide">
                            <div class="carousel-inner">
                                <div class="active item">
                                    <img data-src="holder.js/1900x278/#00bc8c:#fff" class="img-responsive" alt=""></div>
                                <div class="item">
                                    <img data-src="holder.js/1900x278/#5bc0de:#fff" class="img-responsive" alt=""></div>
                                <div class="item">
                                    <img data-src="holder.js/1900x278/#00BC8C:#fff" class="img-responsive" alt=""></div>
                            </div>
                            <!-- Carousel nav -->
                        ...
                        <div class="news-blocks">
                            ...
                            <a href="news_item.php" class="news-block-btn">
                                Read more
                    ...
                    <div class="col-md-3">
                        <div class="news-blocks">
                            ...
                            <p>
                                <img class="news-block-img pull-right" data-src="holder.js/70x70/#00bc8c:#fff" alt="">
