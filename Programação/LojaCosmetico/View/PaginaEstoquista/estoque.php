...
if ((!isset($_SESSION['login']) == true) and ( !isset($_SESSION['senha']) == true) && $_SESSION['tipoUsuario'] !=2) {
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <div class="" style="font-color:black;">
                                        ...
                                        <i class="livicon" data-name="user" data-s="18"> Estoquista </i>
                ...
                if ('undefined' != typeof id) {
                    $.getJSON('../../Controle/controleEstoque.php?enviar=' + id, function (obj) {
                        ...
                        if (obj.status == "ocupado" && obj.codigoFuncional == "diferente") {
                            ...
                            $('td:eq(3)', tr).change('<div class="btn-group"><button  class="btn btn-warning">Ocupado<i class="fa fa-truck"></i></button> </div>');

                            $("#modalErro").modal("show");

                        } else {
                            if (obj.status == "ocupado" && obj.codigoFuncional == "igual") {
                                $('td:eq(3)', tr).change('<div class="btn-group"><button  class=" btn btn-danger" onclick = "remove(this);finalizar(' + obj.id + ');">finalizar<i class="fa fa-truck"></i></button> </div>');
